...
export const seedSampleData = async () => {
  try {
    ...
    const products = [
      ...
      { name: "Pure Turmeric Powder (పసుపు పొడి) - 250g", slug: "pure-turmeric-powder-250g", price: 100, compare_at_price: 120, category_id: catMap["turmeric-products"], unit: "250g", stock: 100, is_featured: true, description: "Pure, stone-ground turmeric powder from Indhur Farms." },
